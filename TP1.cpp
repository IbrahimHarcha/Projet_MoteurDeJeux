...
int main(void)
{
    ...
    Terrain route(32,32,4,12,-8,-8,true,"../textures/road.jpg",-0.0001);
    route.loadTexture("../textures/road.jpg");
...
void processInput(GLFWwindow *window, Terrain &plan)
{
    ...
    {
        // voiture.accelerate(5.0f);  // Accélérer la voiture
        // // voiture.turn(10.0f);     
    ...
    {
        // voiture.decelerate(-5.0f);  // Accélérer la voiture
        // // voiture.turn(-10.0f);  
